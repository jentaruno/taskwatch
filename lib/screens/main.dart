...
class _HomeAppState extends State<HomeApp> {
  ...
  callback(title, time) {
    List<Task> taskList = context.watch<TasksProvider>().taskList;
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
                onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            TaskScreen(task: context.watch<TasksProvider>().taskList[index]))),
                child: GridTile(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(context.watch<TasksProvider>().taskList[index].getTime(0),
